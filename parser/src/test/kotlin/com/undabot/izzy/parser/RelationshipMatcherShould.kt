...
import com.undabot.izzy.models.*
            ...
            DataPool().apply {
                put(ResourceID("1", "articles"),
                        Resource(
                                ...
                                RelationshipFields().apply {
                                    add(ResourceID("2", relationshipNameCoauthors),
                                            fieldWithType(relationshipNameCoauthors, itemWithOneToManyRelationship))
                                    add(ResourceID("3", relationshipNameCoauthors),
                                            fieldWithType(relationshipNameCoauthors, itemWithOneToManyRelationship))
                                }))
                relationshipItemList.forEach {
                    put(ResourceID(it.id!!, relationshipNameCoauthors),
